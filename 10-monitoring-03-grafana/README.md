...
<img width="1440" alt="Screen Shot 2022-04-06 at 9 19 40 PM" src="https://user-images.githubusercontent.com/87324543/162101191-2c0bff99-891c-4667-83ed-4d310f0513bd.png">
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        ...
        {
          "expr": "100 - (avg by (instance) (rate(node_cpu_seconds_total{job=\"nodeexporter\",mode=\"idle\"}[15m])) * 100)",
          "hide": false,
          "interval": "",
    ...
    },
    {
      "alert": {
        ...
        "frequency": "1m",
        "handler": 1,
        "message": "ALERT!\n\nYour Instance is out of free disk space!!",
      ...
      "targets": [
        {
          "expr": "node_filesystem_free_bytes{job=\"nodeexporter\", instance=\"nodeexporter:9100\", mountpoint=\"/var/lib\"}",
          "interval": "",
    ...
    },
    {
      "alert": {
        ...
        "frequency": "1m",
        "handler": 1,
        "message": "ALERT!\n\nYOUR INSTANCE IS OUT OF MEMORY!",
        "name": "Free RAM alert",
        "noDataState": "no_data",
        "notifications": [
          {
